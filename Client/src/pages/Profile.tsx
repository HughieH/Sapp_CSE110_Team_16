...
const Profile = () => {
  return (
    <div data-testid="Profile" className="flex flex-col items-center min-h-screen bg-white text-black">
      <div className="flex flex-col pt-5 px-20 my-20 items-center justify-items w-72 h-42 bg-sapp-green rounded-3xl text-center text-nowrap">
        <img className="w-28" src={ProfileIcon}/>
        <div className="text-white font-bold text-xl"><h1>YOUR NAME</h1></div>
      </div>
      <div className="px-5 w-5/6">
        <h1 className="text-5xl font-bold text-sapp-leaf pl-2 pb-5">
          Statistics
        </h1>
        <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-16 h-50 rounded-3xl gap-5 lg:gap-5">
